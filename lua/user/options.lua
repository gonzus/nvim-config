local options = {
  ...
  cmdheight = 1,                           -- a value > 1 would give more space in the neovim command line for displaying messages
...
vim.cmd "set whichwrap+=<,>,[,]" -- allow the left and right arrow keys to wrap around lines
